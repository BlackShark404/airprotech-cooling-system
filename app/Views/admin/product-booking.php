            ...
            },
            {
                ...
                render: function(data, type, row) {
                    return `<div class="d-flex">
                        <button class="btn btn-sm btn-info me-1 view-btn" data-id="${row.pb_id}">View</button>
                        <button class="btn btn-sm btn-warning me-1 edit-btn" data-id="${row.pb_id}">Edit</button>
                        <button class="btn btn-sm btn-danger delete-btn" data-id="${row.pb_id}">Delete</button>
                    </div>`;
                }
            }
        ],
